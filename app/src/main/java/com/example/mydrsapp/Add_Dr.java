...
public class Add_Dr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQueue = Volley.newRequestQueue(Add_Dr.this);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull @NotNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.search:
                        Intent i1 = new Intent(Add_Dr.this, Search.class);
                    ...
                    case R.id.record:
                        Intent i = new Intent(Add_Dr.this, Record.class);
...
//                String textInput2 = txt2.getText().toString().trim(); //Select Credentials get String
                ...
                if (!editInput.isEmpty() && !editInput1.isEmpty()) {
                    ...
                    AlertDialog.Builder myAlert = new AlertDialog.Builder(Add_Dr.this);
