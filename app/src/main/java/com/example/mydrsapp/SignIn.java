        ...
        userResponseCall.enqueue(new Callback<UserResponse>() {
            ...
            public void onResponse(Call<UserResponse> call, Response<UserResponse> response) {
                ...
                if (msg.equals(msg1)) {
                    if (!setup) {
                        if (name != null) {
                            Intent jump = new Intent(SignIn.this, PSI_Validation.class);
                            jump.putExtra("id", userResponse.getData().getId());
                            startActivity(jump);
                            finish();
                        } else {
                            Intent i2 = new Intent(SignIn.this, New_Provider_Page.class);
                        ...
                        Intent i = new Intent(SignIn.this, Record.class);
