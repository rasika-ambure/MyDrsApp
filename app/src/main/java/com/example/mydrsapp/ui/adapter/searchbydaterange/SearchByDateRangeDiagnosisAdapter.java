...
/*
public class SearchByDateRangeDiagnosisAdapter extends RecyclerView.Adapter<SearchByDateRangeDiagnosisAdapter.AudioViewHolder> {
    ...
    int countDiagnosis;
    private ResultForSearchByDateActivity resultForSearchByDateDiagnosis;

    public SearchByDateRangeDiagnosisAdapter(File[] allFiles, long startDays, long endDays, String id, String name, ResultForSearchByDateActivity resultForSearchByDate2) {
        this.allFiles = allFiles;
        this.startDays = startDays;
        this.endDays = endDays;
        resultForSearchByDateDiagnosis = resultForSearchByDate2;
        this.id = id;
        this.name = name;
    }
    ...
    @NonNull
    @Override
    public SearchByDateRangeDiagnosisAdapter.AudioViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SearchByDateRangeDiagnosisAdapter.AudioViewHolder(view);
    }

    @RequiresApi(api = Build.VERSION_CODES.N)
    @Override
    public void onBindViewHolder(@NonNull SearchByDateRangeDiagnosisAdapter.AudioViewHolder holder, @SuppressLint("RecyclerView") int position) {
        //--------------------------------------------------------------------------------------------------
                    ...
                    public void onClick(View v) {
                        ...
                        myAlert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                resultForSearchByDateDiagnosis.startActivity(intent);
                                resultForSearchByDateDiagnosis.finish();
                            }
                        });
...
//--------------------------------------------------------------------------------------------------
        if (startDays >= diffFT && endDays <= diffFT) {
            if (category.equals("Diagnosis.mp3")) {
                ...
                resultForSearchByDateDiagnosis.diagnosisConstrain.setVisibility(View.VISIBLE);
                resultForSearchByDateDiagnosis.resD.setVisibility(View.GONE);
...
//            holder.list_duration.setVisibility(View.GONE);
            ...
            if (countDiagnosis==0){
                resultForSearchByDateDiagnosis.diagnosisConstrain.setVisibility(View.GONE);
                resultForSearchByDateDiagnosis.resD.setVisibility(View.GONE);
            }
        }else {
            resultForSearchByDateDiagnosis.diagnosisConstrain.setVisibility(View.GONE);
...
public class SearchByDateRangeDiagnosisAdapter extends RecyclerView.Adapter<SearchByDateRangeDiagnosisAdapter.AudioViewHolder> {
    ...
    private ResultForSearchByDateActivity activityDiagnosis;

    public SearchByDateRangeDiagnosisAdapter(ResultForSearchByDateActivity resultForSearchByDateActivity, ArrayList<RecordingModel> recordingList) {
        this.recordingList = recordingList;
        this.activityDiagnosis = resultForSearchByDateActivity;
    }
...
//---------------------------------- Set Duration --------------------------------------------------
        ...
        holder.container.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activityDiagnosis.getRecordingFilesDiagnosisDate(obj);
            }
        });
//--------------------------------------------------------------------------------------------------
    }
