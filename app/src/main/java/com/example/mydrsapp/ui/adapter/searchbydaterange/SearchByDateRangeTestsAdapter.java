...
/*
public class SearchByDateRangeTestsAdapter extends RecyclerView.Adapter<SearchByDateRangeTestsAdapter.AudioViewHolder> {
    ...
    String id, name;
    int countTests;
    private ResultForSearchByDateActivity resultForSearchByDateTests;

    public SearchByDateRangeTestsAdapter(File[] allFiles, long startDays, long endDays, String id, String name, ResultForSearchByDateActivity resultForSearchByDate4) {
        this.allFiles = allFiles;
        this.startDays = startDays;
        this.endDays = endDays;
        resultForSearchByDateTests = resultForSearchByDate4;
        this.id = id;
        this.name = name;
    }
    ...
    @NonNull
    @Override
    public SearchByDateRangeTestsAdapter.AudioViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SearchByDateRangeTestsAdapter.AudioViewHolder(view);
    }

    @RequiresApi(api = Build.VERSION_CODES.N)
    @Override
    public void onBindViewHolder(@NonNull SearchByDateRangeTestsAdapter.AudioViewHolder holder, @SuppressLint("RecyclerView") int position) {
        //--------------------------------------------------------------------------------------------------
                    ...
                    public void onClick(View v) {
                        ...
                        myAlert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                resultForSearchByDateTests.startActivity(intent);
                                resultForSearchByDateTests.finish();
                            }
                        });
...
//--------------------------------------------------------------------------------------------------
        if (startDays >= diffFT && endDays <= diffFT) {
            if (category.equals("Tests.mp3")) {
                ...
                resultForSearchByDateTests.testsConstrain.setVisibility(View.VISIBLE);
                resultForSearchByDateTests.resT.setVisibility(View.GONE);
...
//            holder.list_duration.setVisibility(View.GONE);
            ...
            if (countTests == 0 ){
                resultForSearchByDateTests.testsConstrain.setVisibility(View.GONE);
                resultForSearchByDateTests.resT.setVisibility(View.GONE);
            }
        }else {
            resultForSearchByDateTests.testsConstrain.setVisibility(View.GONE);
...
public class SearchByDateRangeTestsAdapter extends RecyclerView.Adapter<SearchByDateRangeTestsAdapter.AudioViewHolder> {
    ...
    private ResultForSearchByDateActivity activityTests;

    public SearchByDateRangeTestsAdapter(ResultForSearchByDateActivity resultForSearchByDateActivity, ArrayList<RecordingModel> recordingList) {
        this.recordingList = recordingList;
        this.activityTests = resultForSearchByDateActivity;
    }
...
//---------------------------------- Set Duration --------------------------------------------------
        ...
        holder.container.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activityTests.getRecordingFilesTestsDate(obj);
            }
        });
//--------------------------------------------------------------------------------------------------
    }
