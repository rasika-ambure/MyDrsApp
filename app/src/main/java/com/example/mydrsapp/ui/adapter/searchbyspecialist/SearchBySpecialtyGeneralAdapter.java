...
public class SearchBySpecialtyGeneralAdapter extends RecyclerView.Adapter<SearchBySpecialtyGeneralAdapter.AudioViewHolder> {
    ...
    private ResultForSpecialtyActivity activityGeneral;
    View view;

    public SearchBySpecialtyGeneralAdapter(ResultForSpecialtyActivity resultForSpecialtyActivity, ArrayList<RecordingModel> recordingList) {
        this.recordingList = recordingList;
        this.activityGeneral = resultForSpecialtyActivity;
    }
...
//---------------------------------- Set Duration --------------------------------------------------
        ...
        holder.container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                activityGeneral.getRecordingFilesGeneralSpecialty(obj);
            }
        });
//--------------------------------------------------------------------------------------------------
    }
    ...
    public void updateDataGeneral(ArrayList<RecordingModel> recordingList) {
        this.recordingList = recordingList;
        notifyDataSetChanged();
        activityGeneral.resG.setVisibility(View.GONE);
    }
...
public class SearchBySpecialtyGeneralAdapter extends RecyclerView.Adapter<SearchBySpecialtyGeneralAdapter.AudioViewHolder> {
    ...
    public SearchBySpecialtyGeneralAdapter(File[] allFiles, String specialtyName, String provider, String id, String name, ResultForSpecialtyActivity resultForSpecialtyGeneral) {
        this.allFiles = allFiles;
        this.specialtyName = specialtyName;
        this.provider = provider;
        activityGeneral = resultForSpecialtyGeneral;
        this.id = id;
        this.name = name;
    }
    ...
    @NonNull
    @Override
    public SearchBySpecialtyGeneralAdapter.AudioViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_list_item, parent, false);
        timeAgo = new TimeAgo();
        ...
        return new SearchBySpecialtyGeneralAdapter.AudioViewHolder(view);
    }

    @RequiresApi(api = Build.VERSION_CODES.N)
    @Override
    public void onBindViewHolder(@NonNull SearchBySpecialtyGeneralAdapter.AudioViewHolder holder, @SuppressLint("RecyclerView") int position) {
                    ...
                    public void onClick(View v) {
                        ...
                        myAlert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                activityGeneral.startActivity(intent);
                                activityGeneral.finish();
                            }
                        });
...
//--------------------------------------------------------------------------------------------------
        ...
        if (specialty.equals(specialtyName) && providerName.equals(provider)) {
            if (category.equals("General.mp3")) {

                holder.list_title.setText(patient + "-" + specialty + "-" + providerName + "-" + category);

                countGeneral = countGeneral+1;
                Log.i("countGeneral", String.valueOf(countGeneral));
                activityGeneral.generalConstrain.setVisibility(View.VISIBLE);
                activityGeneral.resG.setVisibility(View.GONE);
...
//        holder.list_date.setText(lastModDate.toString()); // for actual date
            ...
            if (!"General.mp3".equals(category)){
...
//            holder.list_duration.setVisibility(View.GONE);
        ...
        Log.i("Total countGeneral", String.valueOf(countGeneral));
        if (countGeneral==0){
            activityGeneral.generalConstrain.setVisibility(View.GONE);
            activityGeneral.resG.setVisibility(View.GONE);
        }
    }
