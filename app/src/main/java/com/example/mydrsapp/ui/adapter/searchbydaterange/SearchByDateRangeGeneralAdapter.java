...
/*
public class SearchByDateRangeGeneralAdapter extends RecyclerView.Adapter<SearchByDateRangeGeneralAdapter.AudioViewHolder> {
    ...
    String id, name;
    int countGeneral;
    private ResultForSearchByDateActivity resultForSearchByDateGeneral;

    public SearchByDateRangeGeneralAdapter(File[] allFiles, long startDays, long endDays, String id, String name, ResultForSearchByDateActivity resultForSearchByDate1) {
        this.allFiles = allFiles;
        this.startDays = startDays;
        this.endDays = endDays;
        resultForSearchByDateGeneral = resultForSearchByDate1;
        this.id = id;
        this.name = name;
    }
    ...
    @NonNull
    @Override
    public SearchByDateRangeGeneralAdapter.AudioViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SearchByDateRangeGeneralAdapter.AudioViewHolder(view);
    }

    @RequiresApi(api = Build.VERSION_CODES.N)
    @Override
    public void onBindViewHolder(@NonNull SearchByDateRangeGeneralAdapter.AudioViewHolder holder, @SuppressLint("RecyclerView") int position) {
        //--------------------------------------------------------------------------------------------------
                    ...
                    public void onClick(View v) {
                        ...
                        myAlert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                resultForSearchByDateGeneral.startActivity(intent);
                                resultForSearchByDateGeneral.finish();
                            }
                        });
...
//--------------------------------------------------------------------------------------------------
        if (startDays >= diffFT && endDays <= diffFT) {
            if (category.equals("General.mp3")) {
                ...
                resultForSearchByDateGeneral.generalConstrain.setVisibility(View.VISIBLE);
                resultForSearchByDateGeneral.resG.setVisibility(View.GONE);
...
//            holder.list_duration.setVisibility(View.GONE);
            ...
            if (countGeneral == 0){
                resultForSearchByDateGeneral.generalConstrain.setVisibility(View.GONE);
                resultForSearchByDateGeneral.resG.setVisibility(View.GONE);
            }
        } else {
            resultForSearchByDateGeneral.generalConstrain.setVisibility(View.GONE);
...
public class SearchByDateRangeGeneralAdapter extends RecyclerView.Adapter<SearchByDateRangeGeneralAdapter.AudioViewHolder> {
    ...
    private ResultForSearchByDateActivity activityGeneral;

    public SearchByDateRangeGeneralAdapter(ResultForSearchByDateActivity resultForSpecialtyActivity, ArrayList<RecordingModel> recordingList) {
...
//---------------------------------- Set Duration --------------------------------------------------
        ...
        holder.container.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activityGeneral.getRecordingFilesGeneralDate(obj);
            }
        });
//--------------------------------------------------------------------------------------------------
    }
