package com.example.mydrsapp.ui.adapter.lastthreerecordings;
...
import com.example.mydrsapp.ui.activity.LastThreeRecordingsActivity;
...
public class LastThreeRecordingsAdapter extends RecyclerView.Adapter<LastThreeRecordingsAdapter.AudioViewHolder> {
    ...
    private LastThreeRecordingsActivity activity;

    public LastThreeRecordingsAdapter(LastThreeRecordingsActivity activity, ArrayList<RecordingModel> recordingList) {
...
//--------------------------------- For Offline Recordings------------------------------------------
    ...
    private LastThreeRecordingsActivity lastThreeRecordingsActivity;

    public LastThreeRecordingsAdapter(File[] allFiles, String id, String name, LastThreeRecordingsActivity lastThreeRecordingsActivity) {
        this.allFiles = allFiles;
        this.id = id;
        this.name = name;
        this.lastThreeRecordingsActivity = lastThreeRecordingsActivity;
                    ...
                    public void onClick(View v) {
                        ...
                        myAlert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                lastThreeRecordingsActivity.startActivity(intent);
                                lastThreeRecordingsActivity.finish();
                            }
                        });
