...
/*
public class SearchBySpecialtyTestsAdapter extends RecyclerView.Adapter<SearchBySpecialtyTestsAdapter.AudioViewHolder> {
    ...
    private ResultForSpecialtyActivity activityTests;

    String id, name;

    public SearchBySpecialtyTestsAdapter(File[] allFiles, String specialtyName, String provider, String id, String name, ResultForSpecialtyActivity resultForSpecialty3) {
        this.allFiles = allFiles;
        this.specialtyName = specialtyName;
        this.provider = provider;
        activityTests = resultForSpecialty3;
        this.id = id;
        this.name = name;
    }
    ...
    @NonNull
    @Override
    public SearchBySpecialtyTestsAdapter.AudioViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SearchBySpecialtyTestsAdapter.AudioViewHolder(view);
    }

    @RequiresApi(api = Build.VERSION_CODES.N)
    @Override
    public void onBindViewHolder(@NonNull SearchBySpecialtyTestsAdapter.AudioViewHolder holder, @SuppressLint("RecyclerView") int position) {
                    ...
                    public void onClick(View v) {
                        ...
                        myAlert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                activityTests.startActivity(intent);
                                activityTests.finish();
                            }
                        });
...
//--------------------------------------------------------------------------------------------------
        ...
        if (specialty.equals(specialtyName) && providerName.equals(provider)) {
            if (category.equals("Tests.mp3")) {
                holder.list_title.setText(patient + "-" + specialty + "-" + providerName + "-" + category);

                countTests = countTests + 1;
                Log.i("countMedications", String.valueOf(countTests));
                activityTests.testsConstrain.setVisibility(View.VISIBLE);
                activityTests.resT.setVisibility(View.GONE);
...
//            holder.list_duration.setVisibility(View.GONE);
        ...
        Log.i("Total countTests", String.valueOf(countTests));

        if (countTests==0) {
            activityTests.testsConstrain.setVisibility(View.GONE);
            activityTests.resT.setVisibility(View.GONE);
        }
    }
...
public class SearchBySpecialtyTestsAdapter extends RecyclerView.Adapter<SearchBySpecialtyTestsAdapter.AudioViewHolder> {
    ...
    public SearchBySpecialtyTestsAdapter(ResultForSpecialtyActivity resultForSpecialtyActivity, ArrayList<RecordingModel> recordingList) {
        this.recordingList = recordingList;
        this.activityTests = resultForSpecialtyActivity;
    }
...
//---------------------------------- Set Duration --------------------------------------------------
        ...
        holder.container.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activityTests.getRecordingFilesTestsSpecialty(obj);
            }
        });
//--------------------------------------------------------------------------------------------------
    }
    ...
    public void updateDataTests(ArrayList<RecordingModel> recordingList) {
        this.recordingList = recordingList;
