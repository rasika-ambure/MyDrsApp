...
public class SearchBySpecialtyMedicationsAdapter extends RecyclerView.Adapter<SearchBySpecialtyMedicationsAdapter.AudioViewHolder> {
    ...
    private ResultForSpecialtyActivity activityMedications;
    View view;

    public SearchBySpecialtyMedicationsAdapter(ResultForSpecialtyActivity resultForSpecialtyActivity, ArrayList<RecordingModel> recordingList) {
        this.recordingList = recordingList;
        this.activityMedications = resultForSpecialtyActivity;
    }
...
//---------------------------------- Set Duration --------------------------------------------------
        ...
        holder.container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                activityMedications.getRecordingFilesMedicationsSpecialty(obj);
            }
        });
//--------------------------------------------------------------------------------------------------
    }
...
public class SearchBySpecialtyMedicationsAdapter extends RecyclerView.Adapter<SearchBySpecialtyMedicationsAdapter.AudioViewHolder> {
    ...
    public SearchBySpecialtyMedicationsAdapter(File[] allFiles, String specialtyName, String provider, String id, String name, ResultForSpecialtyActivity resultForSpecialty2) {
        this.allFiles = allFiles;
        this.specialtyName = specialtyName;
        this.provider = provider;
        activityMedications = resultForSpecialty2;
        this.id = id;
        this.name = name;
    ...
    @NonNull
    @Override
    public SearchBySpecialtyMedicationsAdapter.AudioViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_list_item, parent, false);
        timeAgo = new TimeAgo();
        ...
        return new SearchBySpecialtyMedicationsAdapter.AudioViewHolder(view);
    }

    @RequiresApi(api = Build.VERSION_CODES.N)
    @Override
    public void onBindViewHolder(@NonNull SearchBySpecialtyMedicationsAdapter.AudioViewHolder holder, @SuppressLint("RecyclerView") int position) {
                    ...
                    public void onClick(View v) {
                        ...
                        myAlert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                activityMedications.startActivity(intent);
                                activityMedications.finish();
                            }
                        });
...
//--------------------------------------------------------------------------------------------------
        ...
        if (specialty.equals(specialtyName) && providerName.equals(provider)) {
            if (category.equals("Medications.mp3")) {
                ...
                Log.i("countMedications", String.valueOf(countMedications));
                activityMedications.medicationConstrain.setVisibility(View.VISIBLE);
                activityMedications.resM.setVisibility(View.GONE);
...
//            holder.list_duration.setVisibility(View.GONE);
        ...
        Log.i("Total countMedications", String.valueOf(countMedications));

        if (countMedications==0) {
            activityMedications.medicationConstrain.setVisibility(View.GONE);
            activityMedications.resM.setVisibility(View.GONE);
        }
