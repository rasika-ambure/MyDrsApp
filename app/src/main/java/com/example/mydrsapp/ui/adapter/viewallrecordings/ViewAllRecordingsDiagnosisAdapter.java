...
/*
public class ViewAllRecordingsDiagnosisAdapter extends RecyclerView.Adapter<ViewAllRecordingsDiagnosisAdapter.AudioViewHolder> {
    ...
    int countDiagnosis;
    String id, name;
    private ViewAllRecordingsActivity viewAllRecordingsDiagnosis;

    public ViewAllRecordingsDiagnosisAdapter(File[] allFiles, String id, String name, ViewAllRecordingsActivity viewAllRecordings3) {
        this.allFiles = allFiles;
        viewAllRecordingsDiagnosis = viewAllRecordings3;
        this.id = id;
        this.name = name;
    }
    ...
    @NonNull
    @Override
    public ViewAllRecordingsDiagnosisAdapter.AudioViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewAllRecordingsDiagnosisAdapter.AudioViewHolder(view);
    }

    @RequiresApi(api = Build.VERSION_CODES.N)
    @Override
    public void onBindViewHolder(@NonNull ViewAllRecordingsDiagnosisAdapter.AudioViewHolder holder, @SuppressLint("RecyclerView") int position) {
...
//--------------------------------------------------------------------------------------------------
        if (category.equals("Diagnosis.mp3")) {
            ...
            viewAllRecordingsDiagnosis.diagnosisConstrain.setVisibility(View.VISIBLE);
            viewAllRecordingsDiagnosis.resD.setVisibility(View.GONE);
...
//            holder.list_duration.setVisibility(View.GONE);
        ...
        if (countDiagnosis==0){
            viewAllRecordingsDiagnosis.diagnosisConstrain.setVisibility(View.GONE);
            viewAllRecordingsDiagnosis.resD.setVisibility(View.GONE);
        }
                    ...
                    public void onClick(View v) {
                        ...
                        myAlert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                viewAllRecordingsDiagnosis.startActivity(intent);
                                viewAllRecordingsDiagnosis.finish();
                            }
                        });
...
public class ViewAllRecordingsDiagnosisAdapter extends RecyclerView.Adapter<ViewAllRecordingsDiagnosisAdapter.AudioViewHolder> {
    ...
    private ViewAllRecActivity activityDiagnosis;

    public ViewAllRecordingsDiagnosisAdapter(ViewAllRecActivity viewAllRecordingsActivity, ArrayList<RecordingModel> recordingList) {
        this.recordingList = recordingList;
        this.activityDiagnosis = viewAllRecordingsActivity;
    }
...
//---------------------------------- Set Duration --------------------------------------------------
        ...
        holder.container.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activityDiagnosis.getRecordingFilesDiagnosis(obj);
            }
        });
//--------------------------------------------------------------------------------------------------
    }
