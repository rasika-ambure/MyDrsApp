...
/*
public class ViewAllRecordingsGeneralAdapter extends RecyclerView.Adapter<ViewAllRecordingsGeneralAdapter.AudioViewHolder> {
    ...
    String id, name;
    private ViewAllRecordingsActivity viewAllRecordingsGeneral;

    public ViewAllRecordingsGeneralAdapter(File[] allFiles, String id, String name, ViewAllRecordingsActivity viewAllRecordings1) {
        this.allFiles = allFiles;
        viewAllRecordingsGeneral = viewAllRecordings1;
        this.id = id;
        this.name = name;
    }
    ...
    @NonNull
    @Override
    public ViewAllRecordingsGeneralAdapter.AudioViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewAllRecordingsGeneralAdapter.AudioViewHolder(view);
    }

    @RequiresApi(api = Build.VERSION_CODES.N)
    @Override
    public void onBindViewHolder(@NonNull ViewAllRecordingsGeneralAdapter.AudioViewHolder holder, @SuppressLint("RecyclerView") int position) {
...
//--------------------------------------------------------------------------------------------------
        if (category.equals("General.mp3")) {
            ...
            viewAllRecordingsGeneral.generalConstrain.setVisibility(View.VISIBLE);
            viewAllRecordingsGeneral.resG.setVisibility(View.GONE);
...
//            holder.list_duration.setVisibility(View.GONE);
        ...
        if (countGeneral == 0) {
            viewAllRecordingsGeneral.generalConstrain.setVisibility(View.GONE);
            viewAllRecordingsGeneral.resG.setVisibility(View.GONE);
        }
                    ...
                    public void onClick(View v) {
                        ...
                        myAlert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                viewAllRecordingsGeneral.startActivity(intent);
                                viewAllRecordingsGeneral.finish();
                            }
                        });
...
public class ViewAllRecordingsGeneralAdapter extends RecyclerView.Adapter<ViewAllRecordingsGeneralAdapter.AudioViewHolder> {
    ...
    private ViewAllRecActivity activityGeneral;

    public ViewAllRecordingsGeneralAdapter(ViewAllRecActivity viewAllRecordingsActivity, ArrayList<RecordingModel> recordingList) {
        this.recordingList = recordingList;
        this.activityGeneral = viewAllRecordingsActivity;
    }
...
//---------------------------------- Set Duration --------------------------------------------------
        ...
        holder.container.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activityGeneral.getRecordingFilesGeneral(obj);
            }
        });
//--------------------------------------------------------------------------------------------------
    }
