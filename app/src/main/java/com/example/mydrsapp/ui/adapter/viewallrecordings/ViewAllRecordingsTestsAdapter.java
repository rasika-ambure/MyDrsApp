...
/*
public class ViewAllRecordingsTestsAdapter extends RecyclerView.Adapter<ViewAllRecordingsTestsAdapter.AudioViewHolder> {
    ...
    String id, name;
    private ViewAllRecordingsActivity viewAllRecordingsTests;

    public ViewAllRecordingsTestsAdapter(File[] allFiles, String id, String name, ViewAllRecordingsActivity viewAllRecordings4) {
        this.allFiles = allFiles;
        viewAllRecordingsTests = viewAllRecordings4;
        this.id = id;
        this.name = name;
    }
    ...
    @NonNull
    @Override
    public ViewAllRecordingsTestsAdapter.AudioViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewAllRecordingsTestsAdapter.AudioViewHolder(view);
    }

    @RequiresApi(api = Build.VERSION_CODES.N)
    @Override
    public void onBindViewHolder(@NonNull ViewAllRecordingsTestsAdapter.AudioViewHolder holder, @SuppressLint("RecyclerView") int position) {
                    ...
                    public void onClick(View v) {
                        ...
                        myAlert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                viewAllRecordingsTests.startActivity(intent);
                                viewAllRecordingsTests.finish();
                            }
                        });
...
//--------------------------------------------------------------------------------------------------
        if (category.equals("Tests.mp3")) {
            ...
            viewAllRecordingsTests.testsConstrain.setVisibility(View.VISIBLE);
            viewAllRecordingsTests.resT.setVisibility(View.GONE);
...
//            holder.list_duration.setVisibility(View.GONE);
        ...
        if (countTests==0) {
            viewAllRecordingsTests.testsConstrain.setVisibility(View.GONE);
            viewAllRecordingsTests.resT.setVisibility(View.GONE);
        }
...
public class ViewAllRecordingsTestsAdapter extends RecyclerView.Adapter<ViewAllRecordingsTestsAdapter.AudioViewHolder> {
    ...
    private ViewAllRecActivity activityTests;

    public ViewAllRecordingsTestsAdapter(ViewAllRecActivity viewAllRecordingsActivity, ArrayList<RecordingModel> recordingList) {
        this.recordingList = recordingList;
        this.activityTests = viewAllRecordingsActivity;
    }
...
//---------------------------------- Set Duration --------------------------------------------------
        ...
        holder.container.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activityTests.getRecordingFilesTests(obj);
            }
        });
//--------------------------------------------------------------------------------------------------
    }
