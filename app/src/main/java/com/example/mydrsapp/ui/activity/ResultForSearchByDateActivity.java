...
import com.example.mydrsapp.ui.adapter.searchbydaterange.SearchByDateRangeDiagnosisAdapter;
import com.example.mydrsapp.ui.adapter.searchbydaterange.SearchByDateRangeGeneralAdapter;
import com.example.mydrsapp.ui.adapter.searchbydaterange.SearchByDateRangeMedicationsAdapter;
import com.example.mydrsapp.ui.adapter.searchbydaterange.SearchByDateRangeTestsAdapter;
...
public class ResultForSearchByDateActivity extends AppCompatActivity {
...
//--------------------------------- For Offline Recordings -----------------------------------------
    public ConstraintLayout generalConstrain;
    public ConstraintLayout diagnosisConstrain;
    public ConstraintLayout medicationConstrain;
    public ConstraintLayout testsConstrain;
    ...
    private SearchByDateRangeGeneralAdapter generalAdapter;
    private SearchByDateRangeDiagnosisAdapter diagnosisAdapter;
    private SearchByDateRangeMedicationsAdapter medicationsAdapter;
    private SearchByDateRangeTestsAdapter testsAdapter;
...
//        timeAgo = new TimeAgo();
        ...
        noRecordings = findViewById(R.id.no_recordings_date);
        Bundle bundle = getIntent().getExtras();
        if (bundle != null) {
            startDays = bundle.getLong("startDays");
            Log.i("Start Days ResultDR", String.valueOf(startDays));
            endDays = bundle.getLong("endDays");
            Log.i("End Days ResultDR", String.valueOf(endDays));
            patientId = bundle.getString("id10");
        ...
        Log.i("Outside Share ID", patientId);
        Log.i("Outside Share Name", patientName);


        generalConstrain = findViewById(R.id.general_constrain_RFS_RFSBD);
        downBtnG = findViewById(R.id.down_arrow_RFS_RFSBD);
        audioListG = findViewById(R.id.audio_general_RFS_RFSBD);
        resG = findViewById(R.id.visible_or_invisible_general_RFS_RFSBD);
        resG.setVisibility(View.VISIBLE);
        downBtnG.setBackgroundResource(R.drawable.ic_down);

        diagnosisConstrain = findViewById(R.id.diagnosis_constrain_RFS_RFSBD);
        downBtnD = findViewById(R.id.down_arrow1_RFS_RFSBD);
        audioListD = findViewById(R.id.audio_diagnosis_RFS_RFSBD);
        resD = findViewById(R.id.visible_or_invisible1_diagnosis_RFS_RFSBD);
        resD.setVisibility(View.VISIBLE);
        downBtnD.setBackgroundResource(R.drawable.ic_down);

        medicationConstrain = findViewById(R.id.medication_constrain_RFS_RFSBD);
        downBtnM = findViewById(R.id.down_arrow2_medication_RFS_RFSBD);
        audioListM = findViewById(R.id.audio_medications_RFS_RFSBD);
        resM = findViewById(R.id.visible_or_invisible2_medications_RFS_RFSBD);
        resM.setVisibility(View.VISIBLE);
        downBtnM.setBackgroundResource(R.drawable.ic_down);

        testsConstrain = findViewById(R.id.tests_constrain_RFS_RFSBD);
        downBtnT = findViewById(R.id.down_arrow3_tests_RFS_RFSBD);
        audioListT = findViewById(R.id.audio_tests_RFS_RFSBD);
        resT = findViewById(R.id.visible_or_invisible3_tests_RFS_RFSBD);
        resT.setVisibility(View.VISIBLE);
        downBtnT.setBackgroundResource(R.drawable.ic_down);
/*
//--------------------------------- For Online Recordings ------------------------------------------
        generalAdapter = new SearchByDateRangeGeneralAdapter(allFiles, startDays, endDays, id, name, this);
...
//        audioListG.setLayoutManager(new LinearLayoutManager(this));
        ...
        diagnosisAdapter = new SearchByDateRangeDiagnosisAdapter(allFiles, startDays, endDays, id, name, this);
...
//        audioLisD.setLayoutManager(new LinearLayoutManager(this));
        ...
        medicationsAdapter = new SearchByDateRangeMedicationsAdapter(allFiles, startDays, endDays, id, name, this);
...
//        audioListM.setLayoutManager(new LinearLayoutManager(this));
        ...
        testsAdapter = new SearchByDateRangeTestsAdapter(allFiles, startDays, endDays,  id, name, this);
 ...
 */
        ...
        mQueue = Volley.newRequestQueue(ResultForSearchByDateActivity.this);

        LinearLayoutManager linearLayoutManagerG = new LinearLayoutManager(getApplicationContext());
        linearLayoutManagerG.setReverseLayout(true);
        audioListG.setHasFixedSize(true);
        audioListG.setLayoutManager(linearLayoutManagerG);
        generalAdapter = new SearchByDateRangeGeneralAdapter(this, recordingList);
        audioListG.setAdapter(generalAdapter);
        ...
        audioListD.setHasFixedSize(true);
        audioListD.setLayoutManager(linearLayoutManagerD);
        diagnosisAdapter = new SearchByDateRangeDiagnosisAdapter(this, recordingList);
        audioListD.setAdapter(diagnosisAdapter);
        ...
        audioListM.setHasFixedSize(true);
        audioListM.setLayoutManager(linearLayoutManagerM);
        medicationsAdapter = new SearchByDateRangeMedicationsAdapter(this, recordingList);
        audioListM.setAdapter(medicationsAdapter);
        ...
        audioListT.setHasFixedSize(true);
        audioListT.setLayoutManager(linearLayoutManagerT);
        testsAdapter = new SearchByDateRangeTestsAdapter(this, recordingList);
        audioListT.setAdapter(testsAdapter);
            ...
            public void onResponse(JSONObject response1) {
                try {
                    ...
                    for (int i=0; i<recordingList.size(); i++){
                        ...
                        try {
                            date = dateFormat.parse(recordingList.get(i).getCreated());
                        ...
                        try {
                            ...
                            if (startDays >= diffTF && endDays <= diffTF) {
...
//--------------------------------------------------------------------------------------------------
    ...
    public void onBack(View view) {
        Intent i1 = new Intent(ResultForSearchByDateActivity.this, SearchByDateRangeActivity.class);
        i1.putExtra("id", patientId);
    ...
    public void categoryRFDR(View view) {
        switch (view.getId()) {
            case R.id.general_constrain_RFS_RFSBD:
                if (isGenExpanded) {
...
//                    downArrow3.setBackgroundResource(R.drawable.ic_up);
            ...
            case R.id.diagnosis_constrain_RFS_RFSBD:
                if (isGenExpanded) {
                    resD.setVisibility(View.GONE);
                    downBtnD.setBackgroundResource(R.drawable.ic_down);
...
//                    downArrow3.setBackgroundResource(R.drawable.ic_up);
            ...
            case R.id.medication_constrain_RFS_RFSBD:
                if (isGenExpanded) {
                    resM.setVisibility(View.GONE);
                    downBtnM.setBackgroundResource(R.drawable.ic_down);
//                    downArrow1.setBackgroundResource(R.drawable.ic_up);
...
//                    downArrow3.setBackgroundResource(R.drawable.ic_up);
            ...
            case R.id.tests_constrain_RFS_RFSBD:
                if (isGenExpanded) {
                    resT.setVisibility(View.GONE);
                    downBtnT.setBackgroundResource(R.drawable.ic_down);
//                    downArrow1.setBackgroundResource(R.drawable.ic_up);
...
//                    downArrow.setBackgroundResource(R.drawable.ic_up);
    ...
    public void onClickListener(RecordingModel obj) {
        ...
        playerDialog = new Dialog(ResultForSearchByDateActivity.this);
...
//--------------------------------------------------------------------------------------------------
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                pauseAudio();
                AlertDialog.Builder myAlert = new AlertDialog.Builder(ResultForSearchByDateActivity.this);
                ...
                myAlert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent i1 = new Intent(ResultForSearchByDateActivity.this, ResultForSearchByDateActivity.class);
                        i1.putExtra("id14", patientId);
                        i1.putExtra("name13", patientName);
                        i1.putExtra("startDays", startDays);
                        i1.putExtra("endDays", endDays);
                        startActivity(i1);
                        overridePendingTransition(0, 0);
                        finish();
                    }
...
//------------------------------ Set Last Modified -------------------------------------------------
    ...
    public void getRecordingFilesGeneralDate(RecordingModel obj) {
        onClickListener(obj);
    }
    public void getRecordingFilesDiagnosisDate(RecordingModel obj) {
        onClickListener(obj);
    }
    public void getRecordingFilesMedicationsDate(RecordingModel obj) {
        onClickListener(obj);
    }
    public void getRecordingFilesTestsDate(RecordingModel obj) {
        onClickListener(obj);
    }
